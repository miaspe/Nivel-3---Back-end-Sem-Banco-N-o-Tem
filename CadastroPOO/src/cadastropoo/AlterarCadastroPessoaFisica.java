...
public class AlterarCadastroPessoaFisica {
    public static void main(String[] args) {
        List<PessoaFisica> pessoas = lerPessoas();
        Scanner scanner = new Scanner(System.in);

        while (true) {
            System.out.print("Digite o ID da pessoa para alterar (ou 'sair' para encerrar): ");
            ...
            PessoaFisica pessoaParaAlterar = null;
            ...
            if (pessoaParaAlterar != null) {
                ...
                pessoaParaAlterar.setIdade(Integer.parseInt(scanner.nextLine()));

                System.out.println("Pessoa alterada com sucesso!");
            } else {
                System.out.println("Pessoa com o ID fornecido não encontrada.");
            }
        }
    }
